...
import com.example.landactivity.mibandreader.model.BatteryInfoParser;
import com.example.landactivity.mibandreader.model.CommandPool;
import com.example.landactivity.mibandreader.model.Profile;
import com.example.landactivity.mibandreader.model.StepParser;
...
public class LeService extends Service {
    ...
    public class LocalBinder extends Binder {
        ...
        public int connectToGatt() {
            ...
            mTarget.connectGatt(LeService.this, true, mLeGattCallback,BluetoothDevice.TRANSPORT_LE);
            return 0;
        }
    }
